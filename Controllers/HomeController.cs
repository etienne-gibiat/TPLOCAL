...
namespace TPLOCAL1.Controllers
{
    public class HomeController : Controller
    {
            ...
            else
            {
                ...
                switch (id)
                {
                    case "OpinionList":
                        ...
                        return View(id, opinionList.GetAvis("XlmFile/DataAvis.xml"));
                    case "Form":
        ...
        [HttpPost]
        public ActionResult ValidationFormulaire(/*[Bind("Id,Nom,Prenom,Sexe,Addresse,CodePostal,Ville,Email,DateFormation,Formation,AvisCobol,AvisCsharp")] */Avis avis)
        {
